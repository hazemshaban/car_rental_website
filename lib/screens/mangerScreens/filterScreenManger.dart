...
class filterScreenManger extends StatefulWidget {

bool edit=false;
filterScreenManger({this.edit});
  @override
  _filterScreenMangerState createState() => _filterScreenMangerState();
}

class _filterScreenMangerState extends State<filterScreenManger> {
                        ...
                        child: MaterialButton(
                          onPressed: ()async{
                            ...
                            await searchCars(category: dropdownCategory,color: dropdownColor,brand: dropdownBrand,id:(location_idControler.text=='')?'All':location_idControler.text,
                              year:(yearControler.text=='')?'All':yearControler.text,plate_id:(plate_idControler.text=='')?'All':plate_idControler.text,status:(dropdownStatus=='All')?'All':(dropdownStatus=='ACTIVE'?'1':'0'));

                            Navigator.push(context, MaterialPageRoute(builder: (context)=>(!widget.edit)?availableCarsScreenManger():availableCarsScreenManger(edit: widget.edit,)));
                          },
                          child: Text(
                            "Seach",
